...
public class SpmuTestContainer extends TestContainer {

    public SpmuTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/spmu/app.properties",
                // Add this file which is located in CUBA and defines some properties
                // specifically for test environment. You can replace it with your own
                // or add another one in the dateEnd.
    ...
    public static class Common extends SpmuTestContainer {

        public static final SpmuTestContainer.Common INSTANCE = new SpmuTestContainer.Common();
